...
def prompt_leakage_prevention():
    ...
    return {
        "🚨 DATA LEAKAGE PREVENTION": [
            ...
            "",
            "✅ **Sequence**: If you create an internal training split, **Split Data FIRST**, then apply processing. Never split or reuse provided evaluation/test folders as training data.",
